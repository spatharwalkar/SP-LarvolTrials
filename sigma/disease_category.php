...
<tr><td>
    ...
    <table cellpadding="0" cellspacing="0" id="disease_tabs">
		<tr>
            ...
            <td><img id="ProductsImg" src="../images/firstTab.png" /></td><td id="ProductsTab" class="Tab"><?php print $prodLinkName; ?></td><td><img id="CompaniesImg" src="../images/afterTab.png" /></td><td id="CompaniesTab" class="Tab"><?php print $compLinkName; ?></td><td><img id="MOAsImg" src="../images/middleTab.png" /></td><td id="MOAsTab" class="selectTab"><?php print $moaLinkName; ?></td>
			<td><img id="DiseaseOTTImg" src="../images/selectTabConn.png" /></td><td id="DiseaseOTTTab" class="Tab"><?php print $ottLinkName; ?></td>
			<!-- Temporarily disabled the auto HM tab becauase of performance issues (remove html and php comments below to enable it)-->
			<!-- <td><img id="DiseaseOHMImg" src="../images/afterTab.png" /></td><td id="DiseaseOHMTab" class="Tab"><?php //print $ohmLinkName; ?></td></td> --> <td><img id="lastImg" src="../images/lastTab.png" /></td> 
			<td></td>
...
<div id="diseaseTab_content" align="center">             
	...
	?>
    <?php if($tab == 'Companies') print '<div id="Companies" align="center">'.showCompanyTracker($DiseaseCatId, 'DISCATCT', $page).'</div>'; //DISCATCT=DISEASE Category COMPANY TRACKER ?>
    <?php if($tab == 'MOAs') print '<div id="MOAs" align="center">'.showMOATracker($DiseaseCatId, 'DISCATMT', $page).'</div>'; //DISCATMT=DISEASE Category MOA TRACKER ?>
    <?php 
		if($tab == 'DiseaseOTT') { 
		chdir ("..");
	...
	?>
     <?php if($tab == 'DiseaseOHM') { print '<div id="DiseaseOHM" align="center">'; DisplayOHM($arrDiseaseIds, 'DOHM'); print '</div>'; } //DOHM=DISEASE ONLINE HEATMAP ?>
</div>
</td></tr>
</table>
<?php
