...
<tr><td>
    ...
    <table cellpadding="0" cellspacing="0" id="disease_tabs">
		<tr>
            ...
            <td><img id="ProductsImg" src="images/firstTab.png" /></td><td id="ProductsTab" class="Tab"><a href="<?php print $tabCommonUrl.'&tab=Products'; ?>" title="Products">&nbsp;Products&nbsp;</a></td><td><img id="CompaniesImg" src="images/afterTab.png" /></td><td id="CompaniesTab" class="Tab"><a href="<?php print $tabCommonUrl.'&tab=Companies'; ?>" title="Companies">&nbsp;Companies&nbsp;</a></td><td><img id="MOAsImg" src="images/afterTab.png" /></td><td id="MOAsTab" class="Tab"><a href="<?php print $tabCommonUrl.'&tab=MOAs'; ?>" title="MOAs">&nbsp;MOAs&nbsp;</a></td><td><img id="DiseaseOTTImg" src="images/middleTab.png" /></td><td id="DiseaseOTTTab" class="selectTab"><a href="<?php print $tabCommonUrl.'&tab=DiseaseOTT'; ?>" title="Trial Tracker">&nbsp;Trials&nbsp;</a></td><td><img id="lastImg" src="images/selectLastTab.png" /></td><td></td>
            <?php } ?>
