...
<tr><td>
    ...
    <table cellpadding="0" cellspacing="0" id="disease_tabs">
		<tr>
			...
			if($tab == 'Products') {  ?>
            <td><img id="ProductsImg" src="images/firstSelectTab.png" /></td><td id="ProductsTab" class="selectTab"><?php print $prodLinkName; ?></td><td><img id="CompaniesImg" src="images/selectTabConn.png" /></td><td id="CompaniesTab" class="Tab"><?php print $compLinkName; ?></td><td><img id="MOAsImg" src="images/afterTab.png" /></td><td id="MOAsTab" class="Tab"><?php print $moaLinkName; ?></td><td><img id="DiseaseOTTImg" src="images/afterTab.png" /></td><td id="DiseaseOTTTab" class="Tab"><?php print $ottLinkName; ?></td><td><img id="DiseaseOHMImg" src="images/afterTab.png" /></td><td id="DiseaseOHMTab" class="Tab"><?php print $ohmLinkName; ?></td></td><td><img id="lastImg" src="images/lastTab.png" /></td><td></td>
            <?php } else if($tab == 'Companies') {  ?>
            <td><img id="ProductsImg" src="images/firstTab.png" /></td><td id="ProductsTab" class="Tab"><?php print $prodLinkName; ?></td><td><img id="CompaniesImg" src="images/middleTab.png" /></td><td id="CompaniesTab" class="selectTab"><?php print $compLinkName; ?></td><td><img id="MOAsImg" src="images/selectTabConn.png" /></td><td id="MOAsTab" class="Tab"><?php print $moaLinkName; ?></td><td><img id="DiseaseOTTImg" src="images/afterTab.png" /></td><td id="DiseaseOTTTab" class="Tab"><?php print $ottLinkName; ?></td><td><img id="DiseaseOHMImg" src="images/afterTab.png" /></td><td id="DiseaseOHMTab" class="Tab"><?php print $ohmLinkName; ?></td></td><td><img id="lastImg" src="images/lastTab.png" /></td><td></td>
            <?php } else if($tab == 'MOAs') {  ?>
            <td><img id="ProductsImg" src="images/firstTab.png" /></td><td id="ProductsTab" class="Tab"><?php print $prodLinkName; ?></td><td><img id="CompaniesImg" src="images/afterTab.png" /></td><td id="CompaniesTab" class="Tab"><?php print $compLinkName; ?></td><td><img id="MOAsImg" src="images/middleTab.png" /></td><td id="MOAsTab" class="selectTab"><?php print $moaLinkName; ?></td><td><img id="DiseaseOTTImg" src="images/selectTabConn.png" /></td><td id="DiseaseOTTTab" class="Tab"><?php print $ottLinkName; ?></td><td><img id="DiseaseOHMImg" src="images/afterTab.png" /></td><td id="DiseaseOHMTab" class="Tab"><?php print $ohmLinkName; ?></td></td><td><img id="lastImg" src="images/lastTab.png" /></td><td></td>
            <?php } else if($tab == 'DiseaseOTT') {  ?>
            <td><img id="ProductsImg" src="images/firstTab.png" /></td><td id="ProductsTab" class="Tab"><?php print $prodLinkName; ?></td><td><img id="CompaniesImg" src="images/afterTab.png" /></td><td id="CompaniesTab" class="Tab"><?php print $compLinkName; ?></td><td><img id="MOAsImg" src="images/afterTab.png" /></td><td id="MOAsTab" class="Tab"><?php print $moaLinkName; ?><td><img id="DiseaseOTTImg" src="images/middleTab.png" /></td><td id="DiseaseOTTTab" class="selectTab"><?php print $ottLinkName; ?></td><td><img id="DiseaseOHMImg" src="images/selectTabConn.png" /></td><td id="DiseaseOHMTab" class="Tab"><?php print $ohmLinkName; ?></td></td><td><img id="lastImg" src="images/lastTab.png" /></td><td></td>
