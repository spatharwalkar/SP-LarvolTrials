...
VALUES(1, 'New trial', 'New Trial', 6, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_trials dt where adddate(firstreceived_date,%d)>= current_date() and (dt.phase = \"N/A\" or dt.phase=\"0\")",'B40E52DE-A4D6-4C85-8B48-F662A69F4503',NULL),
	(2, 'New P4 trial', 'Clinical Trial status', 8, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_trials dt where adddate(firstreceived_date,%d)>= current_date() and dt.phase = \"4\"",'43EBF0ED-D640-47D1-BA60-0D73B72282F2',NULL),
	(3, 'New P3 trial', 'Clinical Trial status', 10, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_trials dt where adddate(firstreceived_date,%d)>= current_date() and dt.phase in (\"3\",\"3a\")  ",'3946F04E-A3BB-4DA3-9850-ADC5AAFC161D',NULL),
	(4, 'New P2/P3 trial', 'Clinical Trial status', 10, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_trials dt where adddate(firstreceived_date,%d)>= current_date() and dt.phase = \"2/3\"",'0BE6A68E-0DE1-413D-83B7-FD8998BED7E6',NULL),
	(5, 'New P2b trial', 'Clinical Trial status', 9, NULL, "statement`='select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_trials dt where adddate(firstreceived_date,%d)>= current_date() and dt.phase = \"2b\"",'C603180C-F0B6-4504-A4AA-DD979D657BC9',NULL),
	(6, 'New P2 trial', 'Clinical Trial status', 8, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_trials dt where adddate(firstreceived_date,%d)>= current_date() and dt.phase = \"2\"",'D133E268-D967-48FE-82F1-EFA47B5959F2',NULL),
	(7, 'New P2a trial', 'Clinical Trial status', 8, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_trials dt where adddate(firstreceived_date,%d)>= current_date() and dt.phase = \"2a\"",'8AD0C930-817F-4E5A-9F06-D4D196969966',NULL),
	(8, 'New P1/2 trial', 'Clinical Trial status', 8, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_trials dt where adddate(firstreceived_date,%d)>= current_date() and dt.phase = \"1/2\"",'89588D6C-2441-4A6A-B4E9-A2D1F417D517',NULL),
	(9, 'New P1 trial', 'Clinical Trial status', 7, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_trials dt where adddate(firstreceived_date,%d)>= current_date() and dt.phase in (\"1\" , \"1a\", \"1b\", \"1a/1b\", \"1c\") ",'3FA8CA8D-2F09-4212-956B-47CD1DB10ADC',NULL),
	(10, 'Trial initiation date', 'Trial status', 5, 'Initiation date: [date_format(start_date_prev,\'%b %Y\')] ->[date_format(start_date,\'%b %Y\')]', "select larvol_id, cast(coalesce( start_date_lastchanged,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(start_date_lastchanged,%d)>= current_date() and ( start_date_prev<=subdate(dt.start_date,90) or start_date_prev>=adddate(dt.start_date,90) ) and adddate(firstreceived_date,%d)< current_date() ",'CE614710-2CD9-48D0-A3F6-E1392FFC67D0',NULL),
	(11, 'Completed trial', 'Clinical Trial status', 7, '[overall_status_prev] -> Completed', 'select larvol_id, cast(coalesce( overall_status_lastchanged,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(overall_status_lastchanged,%d)>= current_date() and overall_status_prev != "Completed" and dt.overall_status="Completed"  and adddate(firstreceived_date,%d)< current_date() ','624ACA54-7385-409F-9AD3-AC0AEA1CCA6F',NULL),
	(12, 'Trial primary completion', 'Trial status', 8, NULL, 'SKIP','99728CA5-2922-4DE4-8ED6-2E4358FE07A3',NULL),
	(13, 'Trial completion date', 'Trial status', 3, 'Trial completion date: [date_format(completion_date_prev,\'%b %Y\')] ->[date_format(completion_date,\'%b %Y\')]',"select larvol_id, cast(coalesce( completion_date_lastchanged,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(completion_date_lastchanged,%d)>= current_date() and ( completion_date_prev<=subdate(dt.completion_date,90) or completion_date_prev>=adddate(dt.completion_date,90) ) and (dt.primary_completion_date is null or dt.primary_completion_date='0000-00-00')   and adddate(firstreceived_date,15)< current_date() " ,'73DEB650-E6F3-40B0-A056-BF1F93D2AE57',NULL),
	(14, 'Trial primary completion date', 'Trial status', 4, 'Trial primary completion date: [date_format(primary_completion_date_prev,\'%b %Y\')] ->[date_format(primary_completion_date,\'%b %Y\')]',"select larvol_id, cast(coalesce( primary_completion_date_lastchanged,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(primary_completion_date_lastchanged,%d)>= current_date() and ( primary_completion_date_prev<=subdate(dt.primary_completion_date,90) or primary_completion_date_prev>=adddate(dt.primary_completion_date,90) ) and adddate(firstreceived_date,%d)< current_date() " , '99728ca5-2922-4de4-8ed6-2e4358fe07a3',NULL),
	(15, 'Trial termination', 'Trial status', 9, '[overall_status_prev] -> Terminated', "select larvol_id, cast(coalesce( overall_status_lastchanged,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(overall_status_lastchanged,%d)>= current_date() and overall_status_prev != 'Terminated' and dt.overall_status='Terminated' and adddate(firstreceived_date,%d)< current_date() ",'1C310D6F-145C-4666-9DE7-94350A7DC999',NULL),
	(16, 'Trial suspension', 'Trial status', 9, '[overall_status_prev] -> Suspended', "select larvol_id, cast(coalesce( overall_status_lastchanged,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(overall_status_lastchanged,%d)>= current_date() and overall_status_prev != 'Suspended' and dt.overall_status='Suspended' and adddate(firstreceived_date,%d)< current_date() ",'B26B287B-4B4B-4159-B9BE-183ED1669B84',NULL),
	(17, 'Trial withdrawal', 'Trial status', 10, '[overall_status_prev] -> Withdrawn', "select larvol_id, cast(coalesce( overall_status_lastchanged,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(overall_status_lastchanged,%d)>= current_date() and overall_status_prev != 'Withdrawn' and dt.overall_status='Withdrawn'  and adddate(firstreceived_date,%d)< current_date() ",'4A249ED2-912A-42C7-93C9-9F9FEC4BE7F7',NULL),
	(18, 'Enrollment open', 'Enrollment status', 6, '[overall_status_prev] -> [overall_status]', "select larvol_id, cast(coalesce( overall_status_lastchanged,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(overall_status_lastchanged,%d)>= current_date() and overall_status_prev NOT IN ('Recruiting','Enrolling by invitation') and dt.overall_status IN ('Recruiting','Enrolling by invitation') and adddate(firstreceived_date,%d)< current_date() ",'BC304BFE-CFB3-419F-8BCF-525FDB91C441',NULL),
	(19, 'Enrollment closed', 'Enrollment status', 5, '[overall_status_prev] -> Active, not recruiting', "select larvol_id, cast(coalesce( overall_status_lastchanged,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(overall_status_lastchanged,%d)>= current_date() and overall_status_prev != 'Active, not recruiting' and dt.overall_status='Active, not recruiting'  and adddate(firstreceived_date,%d)< current_date() ",'CFB6E9C6-4A6D-482A-9C7C-6EE33A7AD35B',NULL),
	(20, 'Target Enrollment', 'Enrollment status', 5, 'N=[enrollment_prev] -> [enrollment]', "select larvol_id, cast(coalesce( enrollment_lastchanged,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(enrollment_lastchanged,%d)>= current_date() and abs(enrollment_prev-dt.enrollment)/enrollment_prev >= 0.2 and enrollment_prev >= 10  and adddate(firstreceived_date,%d)< current_date() ",'3DAE8220-BDF9-46A8-9E51-92DE85DE8161',NULL),
	(21, 'Phase Classification', 'Clinical Trial status', 2, 'Phase classification: P[phase_prev] -> P[phase]', "select larvol_id, cast(coalesce( phase_lastchanged,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(phase_lastchanged,%d)>= current_date() and phase_prev!=dt.phase and adddate(firstreceived_date,%d)< current_date() ",'51BCAC2B-6EB7-42F8-850B-C03E9DA0A287',NULL),
	(22, 'Phase Shift', 'Clinical Trial status', 10, 'P[phase_prev] -> P[phase]', "SKIP",'7A4EB458-CD4B-45F0-84A9-D887893215A0',NULL),
	(23,'Clinical Trial,Phase I','Other',1,'Phase 1 Data','SKIP',"2c8f8dba-604d-49d3-829e-dc9c1f35459f","select pm_id, concat(pubmeddata_date_year,"-",LPAD(pubmeddata_date_month, 2, '0'),"-",LPAD(pubmeddata_date_day, 2, '0')) as added from pubmed_abstracts where publicationtype = 'Clinical Trial, Phase I'"),
	(24,'Clinical Trial,Phase II','Other',1,'Phase 2 Data','SKIP',"6a5d36fe-c676-49a5-85e9-7d6ce80b82db","select pm_id, concat(pubmeddata_date_year,"-",LPAD(pubmeddata_date_month, 2, '0'),"-",LPAD(pubmeddata_date_day, 2, '0')) as added  from pubmed_abstracts where publicationtype = 'Clinical Trial, Phase II'"),
	(25,'Clinical Trial,Phase III','Other',1,'Phase 3 Data','SKIP',"37676fb8-c278-41dd-a008-992117fb0da4","select pm_id, concat(pubmeddata_date_year,"-",LPAD(pubmeddata_date_month, 2, '0'),"-",LPAD(pubmeddata_date_day, 2, '0')) as added  from pubmed_abstracts where publicationtype = 'Clinical Trial, Phase III'"),
	(26,'Clinical Trial,Phase IV','Other',1,'Phase 4 Data','SKIP',"e293e17a-3fba-4ba6-8d46-bd0acc69995b","select pm_id, concat(pubmeddata_date_year,"-",LPAD(pubmeddata_date_month, 2, '0'),"-",LPAD(pubmeddata_date_day, 2, '0')) as added  from pubmed_abstracts where publicationtype = 'Clinical Trial, Phase IV'"),
	(27,'Review','Other',1,'Review','SKIP',"555b8f0f-60c6-4c4d-b98b-28227dc42996","select pm_id, concat(pubmeddata_date_year,"-",LPAD(pubmeddata_date_month, 2, '0'),"-",LPAD(pubmeddata_date_day, 2, '0')) as added from pubmed_abstracts where publicationtype = 'Review'"),
	(28,'Enrollment status', 'Enrollment status', 4, '[overall_status_prev] -> [overall_status]', "select larvol_id, cast(coalesce( overall_status_lastchanged,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(overall_status_lastchanged,%d)>= current_date() and overall_status_prev IN ('Recruiting','Enrolling by invitation') and dt.overall_status IN ('Recruiting','Enrolling by invitation') and dt.overall_status<>overall_status_prev",'468a279c-33c9-4766-9eb2-0b87cca81dd2',NULL),
	(29,'Journal Article','Other',1,'Journal Article','SKIP',"1389c491-83ea-4d4b-9343-4280a28e32a0","select pm_id, concat(pubmeddata_date_year,"-",LPAD(pubmeddata_date_month, 2, '0'),"-",LPAD(pubmeddata_date_day, 2, '0')) as added from pubmed_abstracts where publicationtype = 'Journal Article'"),
	(30,'Biomarker','Other',1,'Biomarker','SKIP',"d983ea13-378b-43c6-a4a8-da99c837f82e","select pm_id, concat(pubmeddata_date_year,"-",LPAD(pubmeddata_date_month, 2, '0'),"-",LPAD(pubmeddata_date_day, 2, '0')) as added  from pubmed_abstracts where PREG_RLIKE('/Biomarker|Pharmacological Biomarker/i',CONCAT_WS('',mesh_terms,' ',abstract_text))"),
	(31,'Preclinical','Other',1,'Preclinical','SKIP',"8fc6386d-7093-4fc8-a6f8-6564fc2124eb","select pm_id, concat(pubmeddata_date_year,"-",LPAD(pubmeddata_date_month, 2, '0'),"-",LPAD(pubmeddata_date_day, 2, '0')) as added  from pubmed_abstracts where PREG_RLIKE('/Drug evaluation|Preclinical/i',CONCAT_WS('',mesh_terms,' ',abstract_text))"),
	(32,'Clinical Other','Other',1,'Clinical Other','SKIP',NULL,"select pm_id, concat(pubmeddata_date_year,"-",LPAD(pubmeddata_date_month, 2, '0'),"-",LPAD(pubmeddata_date_day, 2, '0')) as added  from pubmed_abstracts where PREG_RLIKE('/Randomized Clinical Trial|Controlled Clinical Trial|Multicenter Study/i',CONCAT_WS('',mesh_terms,' ',abstract_text))"),
	(33,'Retrospective data','Other',1,'Retrospective data','SKIP',"e51bafca-bc21-4234-9ff8-81e0a7bd4fec","select pm_id, concat(pubmeddata_date_year,"-",LPAD(pubmeddata_date_month, 2, '0'),"-",LPAD(pubmeddata_date_day, 2, '0')) as added  from pubmed_abstracts where PREG_RLIKE('/Retrospective Study/i',CONCAT_WS('',mesh_terms,' ',abstract_text))");
