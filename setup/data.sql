...
VALUES(1, 'New trial', 'New Trial', 6, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_trials dt where adddate(firstreceived_date,%d)>= current_date() and (dt.phase = \"N/A\" or dt.phase=\"0\")",'B40E52DE-A4D6-4C85-8B48-F662A69F4503',NULL),
	...
	(3, 'New P3 trial', 'Clinical Trial status', 10, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_trials dt where adddate(firstreceived_date,%d)>= current_date() and dt.phase = \"3\"",'3946F04E-A3BB-4DA3-9850-ADC5AAFC161D',NULL),
	...
	(9, 'New P1 trial', 'Clinical Trial status', 7, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_trials dt where adddate(firstreceived_date,%d)>= current_date() and dt.phase = \"1\"",'3FA8CA8D-2F09-4212-956B-47CD1DB10ADC',NULL),
	...
	(23,'Clinical Trial,Phase I','Other',4,'Phase 1 Data','SKIP',NULL,"select pm_id, concat(t.pubmeddata_date_year,"-",LPAD(t.pubmeddata_date_month, 2, '0'),"-",LPAD(t.pubmeddata_date_day, 2, '0')) as added from pubmed_abstracts where publicationtype = 'Clinical Trial, Phase I'"),
	(24,'Clinical Trial,Phase II','Other',7,'Phase 2 Data','SKIP',NULL,"select pm_id, concat(t.pubmeddata_date_year,"-",LPAD(t.pubmeddata_date_month, 2, '0'),"-",LPAD(t.pubmeddata_date_day, 2, '0')) as added  from pubmed_abstracts where publicationtype = 'Clinical Trial, Phase II'"),
	(25,'Clinical Trial,Phase III','Other',8,'Phase 3 Data','SKIP',NULL,"select pm_id, concat(t.pubmeddata_date_year,"-",LPAD(t.pubmeddata_date_month, 2, '0'),"-",LPAD(t.pubmeddata_date_day, 2, '0')) as added  from pubmed_abstracts where publicationtype = 'Clinical Trial, Phase III'"),
	(26,'Clinical Trial,Phase IV','Other',7,'Phase 4 Data','SKIP',NULL,"select pm_id, concat(t.pubmeddata_date_year,"-",LPAD(t.pubmeddata_date_month, 2, '0'),"-",LPAD(t.pubmeddata_date_day, 2, '0')) as added  from pubmed_abstracts where publicationtype = 'Clinical Trial, Phase IV'"),
