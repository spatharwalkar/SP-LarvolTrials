...
VALUES(1, 'New trial', 'New Trial', 6, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_trials dt where adddate(firstreceived_date,%d)>= current_date() and (dt.phase = \"N/A\" or dt.phase=\"0\")",'B40E52DE-A4D6-4C85-8B48-F662A69F4503',NULL),
	...
	(23,'Clinical Trial,Phase I','Other',4,'Phase 1 Data','SKIP',"2c8f8dba-604d-49d3-829e-dc9c1f35459f","select pm_id, concat(t.pubmeddata_date_year,"-",LPAD(t.pubmeddata_date_month, 2, '0'),"-",LPAD(t.pubmeddata_date_day, 2, '0')) as added from pubmed_abstracts where publicationtype = 'Clinical Trial, Phase I'"),
	...
	(27,'Review','Other',5,'Review','SKIP',"555b8f0f-60c6-4c4d-b98b-28227dc42996","select pm_id, concat(pubmeddata_date_year,"-",LPAD(pubmeddata_date_month, 2, '0'),"-",LPAD(pubmeddata_date_day, 2, '0')) as added from pubmed_abstracts where publicationtype = 'Review'"),
	...
	(29,'Journal Article','Other',5,'Journal Article','SKIP',"62786ac3-95b1-4a49-b255-47ee5241efa6","select pm_id, concat(pubmeddata_date_year,"-",LPAD(pubmeddata_date_month, 2, '0'),"-",LPAD(pubmeddata_date_day, 2, '0')) as added from pubmed_abstracts where publicationtype = 'Journal Article'");
