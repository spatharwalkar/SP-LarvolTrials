...
INSERT INTO `redtags`(`id`, `name`, `type`, `rUIS`, `formula`, `statement`)
VALUES(1, 'New trial', 'New Trial', 6, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_history join data_trials dt using (larvol_id)  where adddate(firstreceived_date,%d)>= current_date() and overall_status_prev is null and (dt.phase = 'N/A' or dt.phase=0)"),
	(2, 'New P4 trial', 'Clinical Trial status', 8, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(firstreceived_date,%d)>= current_date() and overall_status_prev is null and dt.phase = '4'"),
	(3, 'New P3 trial', 'Clinical Trial status', 10, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(firstreceived_date,%d)>= current_date() and overall_status_prev is null and dt.phase = '3'"),
	(4, 'New P2/P3 trial', 'Clinical Trial status', 10, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(firstreceived_date,%d)>= current_date() and overall_status_prev is null and dt.phase = '2/3'"),
	(5, 'New P2b trial', 'Clinical Trial status', 9, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(firstreceived_date,%d)>= current_date() and overall_status_prev is null and dt.phase = '2b'"),
	(6, 'New P2 trial', 'Clinical Trial status', 8, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(firstreceived_date,%d)>= current_date() and overall_status_prev is null and dt.phase = '2'"),
	(7, 'New P2a trial', 'Clinical Trial status', 8, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(firstreceived_date,%d)>= current_date() and overall_status_prev is null and dt.phase = '2a'"),
	(8, 'New P1/2 trial', 'Clinical Trial status', 8, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(firstreceived_date,%d)>= current_date() and overall_status_prev is null and dt.phase = '1/2'"),
	(9, 'New P1 trial', 'Clinical Trial status', 7, NULL, "select larvol_id, cast(coalesce( firstreceived_date,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(firstreceived_date,%d)>= current_date() and overall_status_prev is null and dt.phase = '1'"),
	...
	(18, 'Enrollment open', 'Enrollment status', 6, 'Not yet recruiting -> Recruiting', "select larvol_id, cast(coalesce( overall_status_lastchanged,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(overall_status_lastchanged,%d)>= current_date() and overall_status_prev = 'Not yet recruiting' and dt.overall_status='Recruiting'"),
	(19, 'Enrollment closed', 'Enrollment status', 5, '[overall_status_prev] -> Active, not recruiting', "select larvol_id, cast(coalesce( overall_status_lastchanged,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(overall_status_lastchanged,%d)>= current_date() and overall_status_prev != 'Active, not recruiting' and dt.overall_status='Active, not recruiting'"),
	(20, 'Target Enrollment', 'Enrollment status', 5, 'N=[enrollment_prev] -> [enrollment]', "select larvol_id, cast(coalesce( enrollment_lastchanged,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(enrollment_lastchanged,%d)>= current_date() and abs(enrollment_prev-dt.enrollment)/enrollment_prev >= 0.2 and enrollment_prev >= 10"),
	(21, 'Phase Classification', 'Clinical Trial status', 2, 'Phase classification: N/A ->[phase]', "select larvol_id, cast(coalesce( phase_lastchanged,current_date())as date) as added from data_history join data_trials dt using (larvol_id) where adddate(phase_lastchanged,%d)>= current_date() and phase_prev = 'N/A' and dt.phase != 'N/A'  "),
