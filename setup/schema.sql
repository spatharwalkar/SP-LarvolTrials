...
CREATE TABLE IF NOT EXISTS `data_history` (
  ...
  `region_prev` enum('AU_NZ','CA','EU','UK','US','ROW','JP','Other') COLLATE utf8_unicode_ci DEFAULT 'Other',
...
CREATE TABLE IF NOT EXISTS `data_manual` (
  ...
  `region` enum('AU_NZ','CA','EU','UK','US','ROW','JP','Other') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Other',
