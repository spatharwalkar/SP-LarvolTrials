...
BEGIN
	...
	DECLARE dynamicCursor CURSOR FOR SELECT id,`name`,rUIS,formula,statement from redtags;
	...
	dynamicCursorLoop: LOOP
		...
		FETCH dynamicCursor INTO rtag_id,rname,score,frml,stmt;
