...
CREATE TABLE IF NOT EXISTS `schedule` (
  ...
  `calc_HM` tinyint(4) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `data_history` (
  ...
  `responsible_party_name_title_prev` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `responsible_party_name_title_lastchanged` datetime DEFAULT NULL,
  `responsible_party_organization_prev` text COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `oversight_authority_prev` text COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `intervention_other_name_prev` text COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `overall_official_affiliation_prev` text COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `data_manual` (
  ...
  `overall_status` enum('Not yet recruiting','Recruiting','Enrolling by invitation','Active, not recruiting','Completed','Suspended','Terminated','Withdrawn','Available','No Longer Available','Approved for marketing','No longer recruiting','Withheld','Temporarily Not Available') COLLATE utf8_unicode_ci DEFAULT NULL,
